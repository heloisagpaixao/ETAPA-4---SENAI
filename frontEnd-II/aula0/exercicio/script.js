...
const coca = new Bebida("Coca-Cola", 7.5, 350);
const suco = new Bebida("Suco de Laranja", 10.0, 500);
const agua = new Bebida("Água Mineral", 4.0, 500);
const cafe = new Bebida("Café Espresso", 6.5, 50);
const guarana = new Bebida("Guaraná Antártica", 7.0, 350);
const chaGelado = new Bebida("Chá Gelado", 8.0, 400);
